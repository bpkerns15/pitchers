...
def pull_data_from_box_score(home_or_away):
    ...
    #Removes Any Save or Win stat From BOX ------ commented out to avoid syntax warning
...
#Converts the Power Point to a PDF --- commented out for compatiblity issues on Mac w/ the comtypes module
...
def create_presentation(averages):
    ...
    prs = Presentation("UtesTemplate.pptx")
